...
int main()
{
    ...
    char line[MAX], loc[MIN], opcode[MIN], operand[MIN], symAddr[MIN], hexCode[MIN],
        name[MIN], objCode[MIN + 2], length[MIN], start[MIN], startObj[MIN], text[MAX];
